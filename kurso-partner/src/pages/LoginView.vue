  ...
  <div class="relative min-h-screen overflow-hidden">
    ...
    <div class="relative mx-auto flex min-h-screen max-w-md flex-col justify-center px-6 py-16">
      <div class="mb-8 flex items-center gap-3">
        ...
        <div>
          <div class="text-lg font-extrabold tracking-tight">Kurso for Business</div>
          <div class="text-xs text-ink-faint">Кабинет обменника</div>
        </div>
      </div>
      ...
      >
        <div class="mb-1.5 flex items-center gap-2.5">
          ...
          <span class="eyebrow">Вход с 2FA</span>
        </div>
        <h1 class="mb-1 text-[21px] font-extrabold tracking-tight">Двухфакторная защита</h1>
        <p class="mb-5 text-sm leading-relaxed text-ink-muted">
          Войдите по паролю; если включён код из приложения-аутентификатора — введите его ниже.
        </p>
        ...
        <Button
          type="submit"
          :label="busy ? 'Вход…' : 'Подтвердить вход'"
          icon="pi pi-sign-in"
          :loading="busy"
          fluid
        />
        ...
        <p class="mt-4 text-center text-[11px] leading-relaxed text-ink-fainter">
          Тестовый доступ: <span class="tnum text-ink-faint">partner@kurso.io</span> · пароль
          <span class="tnum text-ink-faint">partner12345</span>
        </p>
      </form>
    </div>
  </div>

...
import MerchantSidebar from './MerchantSidebar.vue'
...
<template>
  <div class="flex min-h-screen bg-bg">
    <MerchantSidebar :open="drawerOpen" @navigate="drawerOpen = false" />
    ...
    <div class="flex min-w-0 flex-1 flex-col">
      ...
      >
        ...
        <span class="text-sm font-bold">Kurso for Business</span>
      </div>

      <main class="mx-auto w-full max-w-[1200px] flex-1 px-4 py-6 md:px-8 md:py-8">
        <RouterView />
      </main>
    </div>
  </div>
